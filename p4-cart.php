    ...
    <div class="container-fluid ">
        ...
        <div class="row">
            <div class="col-lg-9" id="frameWork">
                <!-- 1 ITEM ELLEMENT-->
                <div class="row list pt-2 pb-2" id="Mango">
                    <img src="Pictures/Mango-2.jpg" class="product-image col-4 ">
                    <div class="col">
                        <div class="row mb-2">
                            <div class="col align-self-left ml-2 font-weight-bold" id="name0">Mango</div>
                            <div class="col align-self-right ml-2 font-weight-bold " id="eachTag0"> $ <var id="each0">1.99</var> ea.</div>
                        </div>
                        <div class="row mt-1 mb-2 border-top">
                            <div class="col-sm-6  pt-2">
                                <div class="row">
                                    ...
                                    <div class="col input-group" ><input type="text" class="form-control QTY" id="Quantity0"></div>
                ...
                <!-- END OF 1 ITEM ELLEMENT-->
                <div class="row list pt-2 pb-2" id="Apple">
                    <img src="Pictures/appl3.jpg" class="product-image col-4 ">
                    <div class="col">
                        <div class="row mb-2">
                            <div class="col align-self-left ml-2 font-weight-bold" id="name1">Red Apple </div>
                            <div class="col align-self-right ml-2 font-weight-bold" id="eachTag1">$ <var id="each1">2.00</var> /lb</div>
                        </div>
                        <div class="row mt-1 mb-2 border-top">
                            <div class="col-sm-6 pt-2">
                                <div class="row">
                                    <div class="col ml-4"><a class="btn btn-outline-info"  id="Substracting1" ><i class='fa fa-minus'></i></a></div>
                                    <div class="col input-group"><input type="text" id="Quantity1" class="form-control QTY" ></div>
                                    <div class="col "> <a class="btn btn-outline-info " id="Adding1" ><i class="fa fa-plus"></i></a></div>
                                </div>
                            </div>
                            <div class="col-sm-6 pt-2">
                                <div class="row">
                                    <div class="col-7 text-center pt-1" style="font-size:19px" id="totTag1">$ <var id="tot1"></var> </div>
                                    <div class="col ml-2"><a class="btn btn-outline-info" id="Deleting1"><i class="fa fa-close"></i> </a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row list pt-2 pb-2" id="Peach">
                    <img src="Pictures/peach2.jpg" class="product-image col-4 " style="max-width:33%; min-width:33%;">
                    <div class="col ">
                        <div class="flex row">
                            <div class="col align-self-left ml-2 font-weight-bold">Peach</div>
                            <div class="col align-self-right ml-2 font-weight-bold" id="eachTag2">$ <var id="each2">1.40</var> ea.</div>
                        </div>
                        <div class="row mt-1 mb-2 border-top">
                            <div class="col-sm-6 pt-2">
                                <div class="row">
                                    <div class="col ml-4"><a class="btn btn-outline-info " id="Substracting2"><i class='fa fa-minus'></i></a></div>
                                    <div class="col input-group">
                                        <input type="text" id="Quantity2" class="form-control QTY">
                                    </div>
                                    <div class="col "> <a class="btn btn-outline-info " id="Adding2"><i class="fa fa-plus"></i></a></div>
                                </div>
                            </div>
                            <div class="col-sm-6 pt-2">
                                <div class="row">
                                    <div class="col-7 text-center pt-1" style="font-size:19px">$ <var id="tot2"></var> </div>
                                    <div class="col ml-2"><a class="btn btn-outline-info" id="Deleting2"><i class="fa fa-close"></i> </a></div>
                                </div>
                            </div>
                        </div>
                    </div>

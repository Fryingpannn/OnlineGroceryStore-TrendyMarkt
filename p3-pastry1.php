    ...
    <div class="container productwrap shadow-lg mt-3">
        <div class="row">
            <div class="col-md-4 order-2 order-md-1 p-2 m-3 border">
                <img src="Pictures/pastry3.jpeg" alt="Cheesecake">
            </div>
            <div class="col-md-7 order-1 order-md-2 p-2 my-3 border rounded">
                <p class="text-center pt-3 font-weight-bold">Trendy Pastries</p>
                <h2 style="display: inline-block" class="p-3 ml-2 border rounded shadow-sm">Boston Cream Cheese Cake</h2>
                ...
                <p class="lead font-weight-bold text-warning m-4">CAD $6.99</p>
                <p class="m-4"><strong>Unit: </strong>1 x 100g</p>
                ...
                <label for="qty" class="ml-4"><strong>Quantity:</strong>
                    ...
                    <button id="addToCart" class="btn btn-outline-success btn-sm" href="#" role="submit">Add to Cart</button>
                </label>
                <p>
                    ...
                    With the hint of lemon that is added, you'll taste the difference. It adds a lighter and brighter taste.
                    </div>
                </p>
            </div>
        </div>

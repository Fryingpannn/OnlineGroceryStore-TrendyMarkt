    ...
    <div class="container productwrap shadow-lg mt-3">
        <div class="row">
            <div class="col-md-4 order-2 order-md-1 p-2 m-3 border" >
                <img src="Pictures/appl3.jpg" alt="snacks1">
            </div>
            <div class="col-md-7 order-1 order-md-2 p-2 my-3 border rounded">
                <p class="text-center pt-3 font-weight-bold">Trendy Fruits</p>
                <h2 style="display: inline-block" class="p-3 ml-2 border rounded shadow-sm">Red Apple (Quebec)</h2>
                ...
                <p class="lead font-weight-bold text-warning m-4">CAD $2,00</p>
                <p class="m-4"><strong>Unit: </strong>lb</p>
                ...
                These Red apples are incredibly crispy. Beneath its deep red skin lies creamy white flesh that is juicy and sweet. You can snack on it, bake with it, or make juice with it.
                    </div>
                </p>
            </div>
        </div>

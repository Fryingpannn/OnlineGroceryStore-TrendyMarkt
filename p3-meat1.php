    ...
    <div class="container productwrap shadow-lg mt-3">
        <div class="row">
            <div class="col-md-4 order-2 order-md-1 p-2 m-3 border">
                <img src="Pictures/burger.jpg" alt="Krusty Patty">
            </div>
            <div class="col-md-7 order-1 order-md-2 p-2 my-3 border rounded">
                <p class="text-center pt-3 font-weight-bold">Trendy Meat</p>
                <h2 style="display: inline-block" class="p-3 ml-2 border rounded shadow-sm">Krusty Patty</h2>
                ...
                <p><sup>*</sup>&nbsp Other ingredients can be added to the customer discretion</p>
                ...
                <p>
                    ...
                    Our customers go-to food. By taking our authentic beef patty and adding a variety of fresh ingredients, this burger will always leave you wanting more.
                    </div>
                </p>
            </div>
        </div>

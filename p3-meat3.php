    ...
    <div class="container productwrap shadow-lg mt-3">
        <div class="row">
            <div class="col-md-4 order-2 order-md-1 p-2 m-3 border">
                <img src="Pictures/Fish.jpg" alt="Fish Tikka">
            </div>
            <div class="col-md-7 order-2 order-md-1 p-2 my-3 border rounded">
                <p class="text-center pt-3 font-weight-bold">Trendy Meat</p>
                <h2 style="display: inline-block" class="p-3 ml-2 border rounded shadow-sm">Fish Tikka</h2>
                ...
                <p class="lead font-weight-bold text-warning m-4">CAD $7.99</p>
                <p class="m-4"><strong>Unit:</strong>&nbsp Plate of 6 Tikkas</p>
                ...
                <p>
                    ...
                    A mix of taking the best of Indian and Western foods. The fish is wrapped around in cheese and then in bread crumb to create perfect small bites of crunchy goodness. It is served with a bowl of Chicken Korma sauce to enhance the spicyness.  
                    </div>
                </p>
            </div>
        </div>

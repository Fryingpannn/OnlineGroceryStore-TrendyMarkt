    ...
    <div class="container productwrap shadow-lg mt-3">
        <div class="row">
            <div class="col-md-4 order-2 order-md-1 p-2 m-3 border">
                <img src="Pictures/snacks7.jpg" alt="snacks2" class="ramen">
            </div>
            <div class="col-md-7 order-1 order-md-2 p-2 my-3 border rounded">
                <p class="text-center pt-3 font-weight-bold">Trendy Snacks</p>
                <h2 style="display: inline-block" class="p-3 ml-2 border rounded shadow-sm">Ramen Noodles</h2>
                ...
                <p class="lead font-weight-bold text-warning m-4">CAD $0,99</p>
                <p class="m-4"><strong>Unit: </strong>1 x 120g</p>
                ...
                <p class="m-4"><strong>Availability: </strong>Only a few left</p>
                <label for="qty" class="ml-4"><strong>Quantity:</strong>
                    <input type="text" id="qty" name="qty" class="small w-25 text-right" value="1">
                    <button class="btn btn-outline-success btn-sm" id="addToCart" href="#" role="submit">Add to Cart</button>
                </label>
                <p>
                    ...
                    Month after month, this product remains a favourite among people of all ages; the classic instant ramen noodles. Mix it up with an egg for an even richer taste.
                    </div>
                </p>
            </div>
        </div>

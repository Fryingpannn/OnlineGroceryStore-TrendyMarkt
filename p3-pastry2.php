    ...
    <div class="container productwrap shadow-lg mt-3">
        <div class="row">
            <div class="col-md-4 order-2 order-md-1 p-2 m-3 border">
                <img src="Pictures/pastry1.jpeg" alt="pancakes">
            </div>
            <div class="col-md-7 order-1 order-md-2 p-2 my-3 border rounded">
                <p class="text-center pt-3 font-weight-bold">Trendy Pastries</p>
                <h2 style="display: inline-block" class="p-3 ml-2 border rounded shadow-sm">Fluffy Banana Pancakes</h2>
                ...
                <p class="lead font-weight-bold text-warning m-4">CAD $5.99</p>
                
                <p class="m-4"><strong>Unit:</strong>&nbsp 1 x 100g</p>
                ...
                <p>
                    ...
                    <div id="moreinfo" class="collapse text-wrap">
                      The added banana makes all the difference. These pancakes are 'melt-in-your-mouth' good!
                    </div>
                </p>
            </div>
        </div>

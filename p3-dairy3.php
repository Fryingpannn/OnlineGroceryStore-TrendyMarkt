...
<html lang="en">
  <head>
    ...
    <meta name="description" content="This is the product page(cheese) for the grocery store Trendy Markt where we sell the trendiest ingredients.">
    ...
    <div class="container productwrap shadow-lg mt-3">
        <div class="row">
            <div class="col-md-4 order-2 order-md-1 p-2 m-3 border">
                <img src="Pictures/cheese.jpg"  alt="cheese" >
            </div>
            <div class="col-md-7 order-1 order-md-2 p-2 my-3 border rounded">
                <p class="text-center pt-3 font-weight-bold">Trendy Dairy</p>
                <h2 style="display: inline-block" class="p-3 ml-2 border rounded shadow-sm">Mild Cheddar Cheese</h2>
                ...
                <p class="m-4"><strong>Unit: </strong>500 g</p>
                ...
                <p>
                    ...
                    Our cheese will add a great flavour to all your meals, breakfast through dinner.
                    </div>
                </p>
            </div>
        </div>

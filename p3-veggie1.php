...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Matthew Pan & Lea">
    ...
    <div class="container productwrap shadow-lg mt-3">
        <div class="row">
            <div class="col-md-4 order-2 order-md-1 p-2 m-3 border">
                <img src="Pictures/peas.jpg" alt="snacks1">
            </div>
            <div class="col-md-7 order-1 order-md-2 p-2 my-3 border rounded">
                ...
                <h2 style="display: inline-block" class="p-3 ml-2 border rounded shadow-sm">Peas</h2>
                ...
                <p>
                    ...
                    Freshly grown peas. How lucious lies the pea within the pod.
                    </div>
                </p>
            </div>
        </div>

    ...
    <div class="container productwrap shadow-lg mt-3">
        <div class="row">
            ...
            <div class="col-md-7 order-1 order-md-2 p-2 my-3 border rounded">
                ...
                <p class="lead font-weight-bold text-warning m-4">CAD $1,40</p>
                ...
                Peaches with white flesh typically are very sweet with little acidity, with a sweet floral taste.
                Check out our peach relish recipe for a cooking inspiration using these wonderful fruits.
                    </div>
                </p>
            </div>
        </div>

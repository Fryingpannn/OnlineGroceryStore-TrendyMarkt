    ...
    <div class="container productwrap shadow-lg mt-3">
        <div class="row">
            <div class="col-md-4 order-2 order-md-1 p-2 m-3 border">
                <img src="Pictures/snacks4.jpeg" alt="snacks2">
            </div>
            <div class="col-md-7 order-1 order-md-2 p-2 my-3 border rounded">
                <p class="text-center pt-3 font-weight-bold">Trendy Snacks</p>
                <h2 style="display: inline-block" class="p-3 ml-2 border rounded shadow-sm">Flower Cookies</h2>
                ...
                <p class="m-4"><strong>Unit: </strong>10 x 37g</p>
                ...
                <p>
                    ...
                    Almond mixed with chocolate chips. They say that whoever eats these cookies will smell like flowers.
                    </div>
                </p>
            </div>
        </div>

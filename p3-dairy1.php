    ...
    <div class="container productwrap shadow-lg mt-3">
        <div class="row">
            <div class="col-md-4 order-2 order-md-1 p-2 m-3 border">
                <img src="Pictures/eggs.jpg" alt="eggs" >
            </div>
            <div class="col-md-7 order-1 order-md-2 p-2 my-3 border rounded">
                <p class="text-center pt-3 font-weight-bold">Trendy Dairy</p>
                <h2 style="display: inline-block" class="p-3 ml-2 border rounded shadow-sm">Large Eggs</h2>
                ...
                <p class="m-4"><strong>Unit: </strong>30 eggs</p>
                ...
                <p>
                    ...
                    You can't skip our eggs if you are aiming for a full-balanced, delicious, and nutritious breakfast.
                    </div>
                </p>
            </div>
        </div>

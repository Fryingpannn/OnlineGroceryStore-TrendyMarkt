    ...
    <div class="container productwrap shadow-lg mt-3">
        <div class="row">
            <div class="col-md-4 order-2 order-md-1 p-2 m-3 border" >
                <img src="Pictures/Mango-2.jpg" alt="snacks1" style="padding-top:50px; margin-top:50px;max-height:70%; justify-content: center;">
            </div>
            <div class="col-md-7 order-1 order-md-2 p-2 my-3 border rounded">
                <p class="text-center pt-3 font-weight-bold">Trendy Fruits</p>
                <h2 style="display: inline-block" class="p-3 ml-2 border rounded shadow-sm">Ataulfo Mango</h2>
                ...
                <p class="lead font-weight-bold text-warning m-4">CAD $1,99</p>
                <p class="m-4"><strong>Unit: </strong>ea.</p>
                ...
                Mango Ataulfo, also known as Champagne Mango due to their golden yellow outer skin, are produced in Mexico.
                They have a delicious sweet taste with a hint of lemon.
                    </div>
                </p>
            </div>
        </div>
